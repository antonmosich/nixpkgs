...
(
  ...
  stdenv.mkDerivation rec {
    ...
    patches =
      let
        hashes = [
          "sha256-WCt+sVr8Ss/bAI41yMJmcZoIPVO1HFEjw1OVRUPYb+w="
          "sha256-OMQYjTFq0PpO38wAAXRsYUfY8nWoAMcPhKUlbqizIS8="
          "sha256-rxtvrBG4HhGYIvpIGZ7luNH5GPbl7TlqbNHcnR7IZc8="
          "sha256-Hz88P8T5O2ANetnAgfmiJLsucSsdeqZ1FYQQLX0WP3I="
          "sha256-cs5dKI2Am+Kp0/ZqSWqd2h/7Oj+WEBeKgWPVsCeMgwk="
        ];
      in
      [
      ...
      ++ (map (
        n:
        fetchpatch {
          url = "https://aur.archlinux.org/cgit/aur.git/plain/argon_${toString n}.patch?h=grub-improved-luks2-git";
          hash = builtins.elemAt hashes (n - 1);
        }
      ) (lib.range 1 5));
