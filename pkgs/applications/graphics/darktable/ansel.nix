...
stdenv.mkDerivation rec {
  version = "06cd53f71063055a126096556b332bd9788bdb40";
  pname = "ansel";

  src = fetchFromGitHub {
    owner = "aurelienpierreeng";
    repo = "ansel";
    rev = "06cd53f71063055a126096556b332bd9788bdb40";
    # sha256 = "sha256-Jd63ZHnq7iWISqaR5wVgbc2w0h8KFf3+w14g3XOapUc=";
    sha256 = "sha256-ByoCryW8uTXtoFVkbO67prsf/Zee3AWypMtNicujep8=";
  ...
  meta = with lib; {
    description = "A darktable fork with minus the bloat plus some design vision";
    homepage = "https://www.ansel.photos";
