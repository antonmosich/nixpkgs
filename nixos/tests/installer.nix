  ...
  fullDiskEncryption = makeInstallerTest "fullDiskEncryption" {
    createPartitions = ''
      installer.succeed(
          ...
          "echo -n supersecret | cryptsetup luksFormat -q --pbkdf argon2i --pbkdf-force-iterations 4 --pbkdf-memory 32 --pbkdf-parallel 1 --type luks2 /dev/vda2 -",
          ...
          "echo -n supersecret | cryptsetup luksAddKey -q --pbkdf argon2i --pbkdf-force-iterations 4 --pbkdf-memory 32 --pbkdf-parallel 1 --key-file - /dev/vda2 luks.key",
